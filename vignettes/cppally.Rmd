...
To register a C++ template to R, one must declare the `[[cppally::register]]` target after the template declaration. Also worth noting that templates must be defined in header files instead of cpp files.
